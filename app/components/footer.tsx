...
const Footer = () => {
  ...
  return (
    <footer className="bg-black bg-opacity-80 border-t border-gray-800 py-10">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            <h3 className="text-xl font-bold mb-4 text-blue-400">C.D. Totten</h3>
            <p className="text-gray-400">
              Author of hard science fiction exploring humanity's cosmic future.
            </p>
            <div className="mt-4 flex space-x-4">
              ...
              <a href="https://goodreads.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="#books" className="text-gray-400 hover:text-blue-400 transition-colors">
                  Books
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-2">
              For inquiries, please reach out to my publisher:
            </p>
            <a href="mailto:publisher@example.com" className="text-blue-400 hover:text-blue-300 transition-colors">
